<!-- HEADER -->
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:EC4899,40:8B5CF6,100:185FA5&height=230&section=header&text=Shubham%20Vishwakarma&fontSize=48&fontColor=ffffff&fontAlignY=35&desc=Data%20Scientist%20%E2%80%A2%20GenAI%20Engineer%20%E2%80%A2%20Builder&descAlignY=55&descSize=16&animation=fadeIn" width="100%"/>
</div>
...
[![codesharelive](https://img.shields.io/badge/🚀%20codesharelive-EC4899?style=for-the-badge)](https://codesharelive.vercel.app)
...
```python
class ShubhamVishwakarma:

    role        = "Data Scientist & GenAI Engineer @ LTIMindtree"
    experience  = "3+ years | Data Science · Analytics · Software Engineering"
...
### 🌐 codesharelive
[![Live](https://img.shields.io/badge/LIVE-EC4899?style=flat-square)](https://codesharelive.vercel.app)

Real-time collaborative code editor. Create rooms, pair program & debug live — no signup needed.

`WebSockets` `Vercel` `Real-time`
...
Chat-based Q&A over video transcripts & watch-history. **35% better relevance**, 40% fewer hallucinations, 1M+ records, 60% faster query latency.
...
<tbody>
<tr>
<td><b>LTIMindtree (LTM)</b><br/><sub>Bengaluru, India</sub></td>
...
| 🏅 | Achievement |
|:---:|:---|
| 🎯 | **Amazon ML Summer School 2025** — selected among 3,000+ applicants across India |
...
### 📬 Open to roles in Data Science · AI Engineering · MLOps
